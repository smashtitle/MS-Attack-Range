...
iwr -Uri "https://raw.githubusercontent.com/smashtitle/sysmon-modular/refs/heads/master/sysmonconfig-with-filedelete.xml" -OutFile "C:\Tools\Sysmon\sysmonconfig-with-filedelete.xml";
